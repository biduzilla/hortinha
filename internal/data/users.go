...
func (m UserModel) Insert(user *User) error {
	query := `
	INSERT INTO users (name, email, phone, password_hash, activated,deleted)
...
func (m UserModel) GetByEmail(email string) (*User, error) {
	query := `
	SELECT id, created_at, name, phone, email, password_hash, activated, version
	FROM users
